...
Public Class Cr_OrdenServicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_OrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OrdenServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OrdenServicio = New Cr_OrdenServicio
        rpt.Site = Me.Site
        Return rpt
    End Function
