...
Public Class Cr_OrdenServicios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_OrdenServicios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OrdenServicios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OrdenServicios = New Cr_OrdenServicios
        rpt.Site = Me.Site
        Return rpt
    End Function
