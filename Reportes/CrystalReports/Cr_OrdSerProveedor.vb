...
Public Class Cr_OrdSerProveedor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_OrdSerProveedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OrdSerProveedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OrdSerProveedor = New Cr_OrdSerProveedor
        rpt.Site = Me.Site
        Return rpt
    End Function
