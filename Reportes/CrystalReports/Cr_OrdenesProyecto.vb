...
Public Class Cr_OrdenesProyecto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_OrdenesProyecto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OrdenesProyecto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OrdenesProyecto = New Cr_OrdenesProyecto
        rpt.Site = Me.Site
        Return rpt
    End Function
