...
Public Class CrOrdenesFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.CrOrdenesFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrOrdenesFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrOrdenesFecha = New CrOrdenesFecha
        rpt.Site = Me.Site
        Return rpt
    End Function
