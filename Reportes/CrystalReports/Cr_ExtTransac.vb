...
Public Class Cr_ExtTransac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_ExtTransac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ExtTransac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ExtTransac = New Cr_ExtTransac
        rpt.Site = Me.Site
        Return rpt
    End Function
