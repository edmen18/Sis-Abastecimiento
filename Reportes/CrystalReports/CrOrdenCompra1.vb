...
Public Class CrOrdenCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.CrOrdenCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrOrdenCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrOrdenCompra = New CrOrdenCompra
        rpt.Site = Me.Site
        Return rpt
    End Function
