...
Public Class Cr_OrdenFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_OrdenFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OrdenFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OrdenFecha = New Cr_OrdenFecha
        rpt.Site = Me.Site
        Return rpt
    End Function
