...
Public Class Cr_ExtTransaccion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_ExtTransaccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_ExtTransaccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_ExtTransaccion = New Cr_ExtTransaccion
        rpt.Site = Me.Site
        Return rpt
    End Function
