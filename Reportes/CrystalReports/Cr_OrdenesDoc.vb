...
Public Class Cr_OrdenesDoc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_OrdenesDoc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OrdenesDoc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OrdenesDoc = New Cr_OrdenesDoc
        rpt.Site = Me.Site
        Return rpt
    End Function
