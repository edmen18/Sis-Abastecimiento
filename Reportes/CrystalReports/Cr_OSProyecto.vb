...
Public Class Cr_OSProyecto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.Cr_OSProyecto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCr_OSProyecto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cr_OSProyecto = New Cr_OSProyecto
        rpt.Site = Me.Site
        Return rpt
    End Function
